/* @ts-self-types="./staticgrind_effects.d.ts" */
 ...
 */
export function apply_chain(bytes, width, height, seed, params) {
    const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArrayF32ToWasm0(params, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.apply_chain(ptr0, len0, width, height, seed, ptr1, len1);
    if (ret[3]) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./staticgrind_effects_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('staticgrind_effects_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
